...
export default function CameraMode() {
  ...
  const { voiceEnabled, voiceState } = useJarvis()
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background overflow-hidden">
      {!voiceEnabled ? (
        <div className="h-full flex flex-col items-center justify-center bg-background/80 backdrop-blur-sm">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="max-w-[85%] rounded-lg px-2.5 py-2 bg-primary-glow/[0.04] border border-primary-glow/10">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="w-1.5 h-1.5 rounded-full bg-primary-glow/30 animate-pulse" />
                        <span className="w-1.5 h-1.5 rounded-full bg-primary-glow/20 animate-pulse" />
                      </div>
                    </div>
                  </div>
                )}
